<?php
    ...
    $dompdf = new Dompdf();
    $kategori2 = query("SELECT * FROM kategori2");
	$content = ' <center><h1>KANTOR CAMAT PEGASING<br/></h1><h2>Laporan Inventaris Barang Elektronik dan Alat Listrik</h2></center><br/><br/>';;
    ...
    $no = 1;
    foreach ($kategori2 as $all_pegawai ) {
    $content .= "<tr>
        <td>".$no."</td>
