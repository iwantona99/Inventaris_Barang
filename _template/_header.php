...
<head>
  ...
  <link rel="mask-icon" href="<?= asset("_assets/img/design/safari-pinned-tab.svg") ?>" color="#dcdcdc">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	  ...
	  <li class="nav-item <?= isset($pegawai) == 'pegawai' ? 'active' : null ?>">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item <?= isset($kategori2) == 'kategori2' ? 'active' : null ?>" href="<?= base_url('kategori2') ?>">Elektronik/Alat Listrik</a>
            <a class="collapse-item <?= isset($pegawai) == 'pegawai' ? 'active' : null ?>" href="<?= base_url('pegawai') ?>">Mesin/Kendaraan Bermotor</a>
            <a class="collapse-item <?= isset($kategori3) == 'kategori3' ? 'active' : null ?>" href="<?= base_url('kategori3') ?>">Barang Mebelair</a>
      ...
      <!-- Nav Item - Data Pegawai -->
      <li class="nav-item <?= isset($pegawai) == 'output' ? 'active' : null ?>">
        <a class="nav-link" href="<?= base_url('output') ?>">
        
          <span>Cetak Output Inventaris</span></a>
      </li>
