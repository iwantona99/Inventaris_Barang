<?php
    ...
    $result = mysqli_query($koneksi, "SELECT * FROM kategori3 WHERE kodebarang='$kodebarang'");
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="<?= base_url('kategori3') ?>">Data Inventaris</a></li>
...
<div class="card mb-4">
    <div class="card-body">
        <form method="POST" action="<?= base_url('_config/prosesbarang3') ?>?edit" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="ukuran" id="ukuran" value="<?= $data['ukuran'] ?>" placeholder="Ukuran PxL" required autocomplete="off">
                </div>
            </div>
			<div class="form-group row">
                <label for="bahan" class="col-sm-3 col-form-label">Bahan</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="bahan" id="bahan" value="<?= $data['bahan'] ?>" placeholder="Merk/Type" required autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
    ...
    <div class="card-footer">
        ...
        <a href="<?= base_url('kategori3') ?>" class="btn btn-warning"><i class="fas fa-fw fa-chevron-left"></i> Kembali</a>
    </div>
    </form>
</div>
