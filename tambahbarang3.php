...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="<?= base_url('kategori3') ?>">Tambah Barang</a></li>
...
<div class="card mb-4">
    <div class="card-body">
        <form method="POST" action="<?= base_url('_config/prosesbarang3') ?>?add" enctype="multipart/form-data">
			...
			<div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="ukuran" id="ukuran" placeholder="Ukuran PxL" required autocomplete="off">
                </div>
            </div>
           <div class="form-group row">
                <label for="bahan" class="col-sm-3 col-form-label">Bahan</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="bahan" id="bahan" placeholder="Bahan Pembuatan" required autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
